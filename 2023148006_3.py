...
def main():
    ap = argparse.ArgumentParser(description="Task 3 driver")
    ...
    ap.add_argument("--E", type=float, default=0.04)
    ap.add_argument("--outfile", type=str, default="2023148006_3.png")
    args = ap.parse_args()
    ...
    plt.title("Task 3: Effect of word length on utility of suggestions")
